...
def release() {
	if (env.BRANCH_NAME == "master") {
	    ...
	    node {
			checkout([$class: 'GitSCM', branches: [[name: '*/master']], doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'LocalBranch', localBranch: 'master']], submoduleCfg: [], userRemoteConfigs: [[url: 'git@github.com:bobkubista/parent-pom.git']]])
